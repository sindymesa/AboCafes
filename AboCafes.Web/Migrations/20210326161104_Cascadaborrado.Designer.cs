...
namespace AboCafes.Web.Migrations
{
    ...
    [Migration("20210326161104_Cascadaborrado")]
    partial class Cascadaborrado
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AboCafes.Common.Entities.Ciudad", b =>
                {
                    ...
                    b.HasIndex("Name", "DepartamentoId")
                        .IsUnique()
            ...
            modelBuilder.Entity("AboCafes.Common.Entities.Corregimiento", b =>
                {
                    ...
                    b.HasIndex("Name", "CiudadId")
                        .IsUnique()
                        .HasFilter("[CiudadId] IS NOT NULL");
            ...
            modelBuilder.Entity("AboCafes.Common.Entities.Ciudad", b =>
                {
                    b.HasOne("AboCafes.Common.Entities.Departamento", "Departamento")
                        .WithMany("Ciudades")
            ...
            modelBuilder.Entity("AboCafes.Common.Entities.Finca", b =>
                {
                    ...
                    b.HasOne("AboCafes.Common.Entities.Vereda", "Vereda")
                        .WithMany("Fincas")
            ...
            modelBuilder.Entity("AboCafes.Common.Entities.Lote", b =>
                {
                    b.HasOne("AboCafes.Common.Entities.Finca", "Finca")
                        .WithMany("Lotes")
            ...
            modelBuilder.Entity("AboCafes.Common.Entities.Vereda", b =>
                {
                    b.HasOne("AboCafes.Common.Entities.Corregimiento", "Corregimiento")
                        .WithMany("Veredas")
